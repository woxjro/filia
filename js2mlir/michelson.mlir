func.func @smart_contract(param: !michelson.mutez, storage: !michelson.mutez) -> (!michelson.pair<!michelson.list<!michelson.operation>,!michelson.mutez>) {
  ...
  %%2 = "michelson.make_pair"(%operations, %amount) : (!michelson.list<!michelson.operation>, !michelson.mutez) -> !michelson.pair<!michelson.list<!michelson.operation>,!michelson.mutez>
